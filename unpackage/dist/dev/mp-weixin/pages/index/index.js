...
var components = {
  uSwiper: function() {
    return __webpack_require__.e(/*! import() | uview-ui/components/u-swiper/u-swiper */ "uview-ui/components/u-swiper/u-swiper").then(__webpack_require__.bind(null, /*! @/uview-ui/components/u-swiper/u-swiper.vue */ 249))
  },
  uTabs: function() {
...

{
  ...
  methods: {
    ...
    renderList: function renderList() {var _this = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var res;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:if (!(

                _this.current == 0)) {_context.next = 7;break;}_context.next = 3;return (
                  _this.$https.get('/Home/Jzbxcx/questions_list'));case 3:res = _context.sent;
                _this.dataList = _this.qData = res.data.list || [];_context.next = 12;break;case 7:if (!(

                _this.current == 1)) {_context.next = 12;break;}_context.next = 10;return (
                  _this.$https.get('/Home/Jzbxcx/viewpoint_list'));case 10:res = _context.sent;
                _this.dataList = _this.vData = res.data.list || [];case 12:case "end":return _context.stop();}}}, _callee);}))();
